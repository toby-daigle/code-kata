...
## Objectifs
L'objectif de ce Kata est de vous familiariser avec certains concepts de refactoring de code. L'idée n'est pas de réécrire le code à partir de zéro, mais plutôt de s'entraîner à concevoir des tests, en avançant par de petites étapes, en exécutant les tests souvent et en améliorant progressivement le code base.
